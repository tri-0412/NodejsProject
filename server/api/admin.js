...
// Endpoint để đếm số lượng categories
router.get('/orders/count', async (req, res) => {
  try {
    const orderCount = await OrderDAO.countDocuments(); // Đếm số lượng bản ghi trong MongoDB
...
router.get('/customers/count', async (req, res) => {
  try {
    const customerCount = await CustomerDAO.countDocuments(); // Đếm số lượng bản ghi trong MongoDB
...
router.get('/categories/count', async (req, res) => {
  try {
    const categoryCount = await CategoryDAO.countDocuments(); // Đếm số lượng bản ghi trong MongoDB
...
// Endpoint để đếm số lượng products
router.get('/products/count', async (req, res) => {
  try {
    const productCount = await ProductDAO.countDocuments(); // Đếm số lượng bản ghi trong MongoDB
